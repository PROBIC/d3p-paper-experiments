...
def summarize(prefix):
    ...
    for i in range(20):
        with open(prefix + '/log{0}.o'.format(i), 'r') as f:
            ...
            times.append(np.float64(splits[9][1:]))
            losses.append(np.float64(splits[4]))
